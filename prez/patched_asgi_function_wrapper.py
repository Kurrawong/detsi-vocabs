...
class AsgiFunctionApp(func.AsgiFunctionApp):
    def __init__(self, app, http_auth_level):
        super(AsgiFunctionApp, self).__init__(
            None, http_auth_level=http_auth_level)
    ...
    def _add_http_app(
        self, http_middleware: Union[AsgiMiddleware, WsgiMiddleware], function_name: str = None
    ) -> None:
        ...
        @self.route(
            ...
            # <-- this is the patch, removed the leading slash from the route
            route="{*route}",
        )
